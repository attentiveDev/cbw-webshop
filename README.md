...
Die index.php Datei des Front- und des Backends stellt den Haupt-Controller. Es wird in Abhängigkeit der Parameter "module" und "action" der jeweilige Programmcode ausgeführt. Wird der Bereich des Moduls bzw. die Aktion im Modul nicht gefunden, wird das jeweilige Skript mit einer Fehlermeldung abgebrochen.
...
* Warenkorb aus localStorage zurücklesen, falls die Session bzw. der Warenkorb leer ist.